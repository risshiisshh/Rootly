...
export const metadata: Metadata = {
  ...
  description: 'Your carbon intelligence command center. Monitor emissions, track goals, and get AI-powered recommendations.',
}

const DashboardClient = dynamic(
  () => import('@/features/dashboard/DashboardClient').then((mod) => mod.DashboardClient),
  {
    loading: () => (
