...
export const metadata: Metadata = {
  title: 'Activity Log — Rootly',
  description: 'Monitor and manage your environmental footprint in real-time. Log activities across transport, food, energy, and lifestyle categories.',
}

const ActivityClient = dynamic(
  () => import('@/features/activity/ActivityClient').then((mod) => mod.ActivityClient),
  {
    loading: () => (
