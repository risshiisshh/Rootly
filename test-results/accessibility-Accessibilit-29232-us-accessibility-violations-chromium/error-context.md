...
- Name: accessibility.spec.ts >> Accessibility Audits (WCAG AA Compliance) >> Sign In page has no critical or serious accessibility violations
- Location: src/tests/e2e/accessibility.spec.ts:22:7
